...
<div style="max-width:1152px;margin:0 auto;padding:0 32px;">
  <div style="margin-bottom:50px;background:#ffffff;border:1px solid #e9e9e9;padding:24px;border-radius:20px;">
    ...
    <div id="grace-inventory-pagination" style="display:flex;justify-content:space-between;align-items:center;padding-top:16px;border-top:1px solid #e9e9e9;margin-top:4px;">
